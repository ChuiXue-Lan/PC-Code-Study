...
# Only outputs RGB and depth images.
#
# Example:
# blender --background --python render_blender_rgb_depth.py -- --views 10 /path/to/my.obj
#
...
parser = argparse.ArgumentParser(description='Renders given obj file by rotating a camera around it. Outputs only RGB and depth images.')
