...
def main(args, total=False):
    ...
    # 处理所有类别
        ...
        for class_choice in classes:
            ...
            print(f"Inference time: {inference_time * 1000:.2f} ms")
            if not only_evaluate:
                # print("search_vweight")
                search_vweight(class_choice, model_name, prompts)
                # print("search_vweight Finish")
            print("Next class_choice: ============================")
    print("End：============================")
...
if __name__ == '__main__':
    ...
    parser.add_argument('--classchoice', default='airplane')
