...
def get_args():
    ...
    parser.add_argument('--pretrain_dataset_name', default='modelnet40_4modal', type=str)
    parser.add_argument('--validate_dataset_name', default='modelnet40_4modal', type=str)
    ...
    # parser.add_argument('--resume', default='/home/cls2024/ltx/Replicate/CrossMoST-main/outputs/modelnet40_crossmost/resume/checkpoint-best.pth', help='resume from checkpoint')
    # 。。。
...
def main(args):
    ...
    args.entropy_depth = config.entropy_depth
    ...
    if args.load_checkpoint:
        ...
        # 加载模型参数
        model.module.load_state_dict(checkpoint['model'])  # <-- 这里改了
    ...
    if args.eval:
        ...
        print(f"Accuracy of the network on the {len(dataset_val)} test depths: {test_stats['acc1_depth']:.1f}%")
        exit(0)
