...
def merge_new_config(config, new_config):
    if '_BASE_CONFIG_' in new_config:
        ## Lan
        print("new_config['_BASE_CONFIG_']", new_config['_BASE_CONFIG_'])
        new_config['_BASE_CONFIG_'] = "/home/cls2024/ltx/Remake/PTPM-main/OpenPCDet-master/tools/cfgs/dataset_configs/nuscenes_dataset.yaml"
        print("new_config['_BASE_CONFIG_']", new_config['_BASE_CONFIG_'])
        ## End
